                ...
                <div class="col-lg-6 offset-lg-3">
                    ...
                    <div class="cardbox shadow-lg bg-white">
                        ...
                        <div class="cardbox-heading">
                            ...
                            <div class="btn-group float-right">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="update_post.php?id=<?php echo $selected_post_id ?>">Update post</a>
                        ...
                        <div class="cardbox-base">
                            ...
                            <ul>
                                <?php
                                if(isset($_SESSION['id']) != isset($resultLike['user_id'])){
                                  ?>
                                <form method="post" action="">
                                    <button class="btn btn-primary" type="submit" name="like"><i class="fa fa-thumbs-up"></i></button>
                                </form>
                                ...
                                if(isset($_POST['like'])){
                                    $likeCount = 1;
                                    $postID = $_GET['id'];
                                    $addLike = mysqli_query($conn, "INSERT INTO `like_posts`(`like_count`, `user_id`, `post_id`) VALUES ($likeCount,$user_id,$postID)");
                                    if (!$addLike) {
